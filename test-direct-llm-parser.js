...
async function testDirectLLMIntegration() {
  console.log('🧪 Testing Direct LLM Parser Integration');
  console.log('=======================================');
  ...
  // Create the agent - this will now use our LLM parser directly if OpenAI key exists
  console.log('Creating agent...');
  const agent = await createAgent();
  console.log('Agent created');
  
  // No need for monkey patching - the agent should directly use our LLM parser
...
// Run the test
testDirectLLMIntegration().catch(error => {
