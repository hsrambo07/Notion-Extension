/**
 * Test script for multi-part commands (create page and add content)
 * 
 * Run with: node server/test-multi-command.js
 */
...
async function testMultiPartCommand() {
  console.log('🧪 Testing multi-part command functionality...');
  
  // Define test command for creating a page and adding content
  const testCommand = "Create a new page March and add text Meeting notes for Q1 in TEST MCP";
