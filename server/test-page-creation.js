 ...
 * 
 * Run with: node server/test-page-creation.js
 */
...
async function testPageCreation() {
  console.log('🧪 Testing page creation functionality...');
  
  // Define test command explicitly for page creation
  const testCommand = "Create a new page called February in TEST MCP";
