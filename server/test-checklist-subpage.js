/**
 * Test script for adding a checklist item to a subpage
 * 
 * Run with: node server/test-checklist-subpage.js
 */
...
async function testChecklistSubpage() {
  console.log('🧪 Testing adding a checklist item to a subpage...');
  
  // Define test command for adding a checklist item to a subpage
  const testCommand = "add a checklist to buy groceries in January page in TEST MCP page";
